...
export default function DonationPanel() {
    return (
        <section className="donation-section">
            {/* Added defensive inner wrapper container to ensure uniform responsive page framing */}
            <div className="donation-inner-wrapper">
                <div className="donation-container">
                    ...
                    <div className="donation-story-side">
                        ...
                        <h2 className="donation-main-title">
                            Interested in donating to change the life of a child?
                        </h2>
                    ...
                    <div className="donation-channels-side">
                        ...
                        <a href="tel:+254114565070" className="donate-now-action-btn">
                            Donate Now
                        </a>
